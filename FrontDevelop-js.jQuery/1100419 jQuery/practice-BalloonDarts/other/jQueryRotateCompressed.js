...
;(function (k) {
  for (
    var d,
      ...
      h = ['transformProperty', 'WebkitTransform', 'OTransform', 'msTransform', 'MozTransform'],
      g = 0;
    g < h.length;
    g++
  )
  ...
  Wilq32.PhotoEffect.prototype = {
    _setupParameters: function (a) {
      ...
      this._rotationCenterY =
        'string' == typeof this._parameters.center[1]
          ? (parseInt(this._parameters.center[1], 10) / 100) * this._imgHeight * this._aspectH
    ...
    _handleRotation: function (a, b) {
      d || this._img.complete || b
        ? (this._setupParameters(a), this._angle == this._parameters.animateTo ? this._rotate(this._angle) : this._animateStart())
